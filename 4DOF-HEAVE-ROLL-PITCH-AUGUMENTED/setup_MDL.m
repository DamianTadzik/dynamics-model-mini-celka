...
foldernames = ["trims", "validation", "controllers", "controllers/all_LQ", "linearized_A_B_x0_u0"];
for i = 1:length(foldernames)
    addpath(foldernames(i));
end
    
% Obtain model parameters
plant_params = boat_model_parameters_4dof();   % Returns plant parameters structure
