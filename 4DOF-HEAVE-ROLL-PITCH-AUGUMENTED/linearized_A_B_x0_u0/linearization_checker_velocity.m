...
f = figure('Name','open_loop_eigenvalues_in_f_of_velocity','Units','inches','Position',[2 2 5 3]);
hold on;
grid on;
...
ylabel('$\mathrm{Re}\{\lambda_i\}$ [1/s]', ...
    'Interpreter','latex','FontName','Times New Roman');

% title(sprintf( ...
%     'Open-loop eigenvalues along $\\dot{x}_W$ at $z_W = %.2f$ m', ...
%     zW_m), ...
%     'Interpreter','latex','FontName','Times New Roman');

legend(labels, ...
    'Interpreter','latex', ...
    'Location','eastoutside','FontName','Times New Roman');
