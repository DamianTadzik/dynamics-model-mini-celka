...
plot(A(1), A(2)-5, '^', 'Color', [0 0 0], 'MarkerSize', 10);
plot(D(1), D(2)-5, '^', 'Color', [0 0 0], 'MarkerSize', 10);
...
xlabel('Servo horn angle \delta [{\circ}]', ...
    'FontName', 'Times New Roman', ...
    'FontSize', 10);
ylabel('Hydrofoil incidence angle \alpha [{\circ}]', ...
    'FontName', 'Times New Roman', ...
    'FontSize', 10);
...
text(delta_min, x_label_y, '\delta_{\rm min}', ...
    'Interpreter', 'tex', ...
    'FontName', 'Times New Roman', ...
    'FontSize', 10, ...
...
text(delta_max, x_label_y, '\delta_{\rm max}', ...
    'Interpreter', 'tex', ...
    'FontName', 'Times New Roman', ...
    'FontSize', 10, ...
    'HorizontalAlignment', 'center', ...
...
text(y_label_x, alpha_min, '\alpha_{\rm min}', ...
    'Interpreter', 'tex', ...
    'FontName', 'Times New Roman', ...
    'FontSize', 10, ...
...
text(y_label_x, alpha_max, '\alpha_{\rm max}', ...
    'Interpreter', 'tex', ...
    'FontName', 'Times New Roman', ...
    'FontSize', 10, ...
    'HorizontalAlignment', 'left', ...
...
legend( ...
    'Four-bar kinematics', ...
    sprintf('Linear fit: \\alpha = %.2f\\delta%+.1f', p(1), p(2)), ...
    'FontName', 'Times New Roman', ...
    'FontSize', 10, ...
    'Location', 'northwest');
...
legend('Four-bar mechanism', 'Linear fit', ...
       'FontName', 'Times New Roman', ...
       'Location', 'best');
